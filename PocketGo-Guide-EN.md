...
3. Lastest CFW v1.1 Image [(Download)](https://www.dropbox.com/s/8denesg11ytmeez/PocketGo_CFW_v1.1_16-07-2019.img.7z?dl=1)
...
**Note:** If you want update only, download the CFW v1.1 Update Only package [(here)](https://www.dropbox.com/s/pklsh6lub9ch0xq/PocketGo_CFW_v1.1_Update_Only_16-07-2019.zip?dl=1). Extract the contents to 'main' drive and replace when asked.
