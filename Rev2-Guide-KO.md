...
2. 8기가 이상의 SD카드
3. 최신 CFW v3.9 이미지 [(다운로드)](https://www.dropbox.com/s/tboslhr720wzhoe/Bittboy_V2_V2.5_only_v3.9_10-06-19.img.7z?dl=0) (CFW v4.0을 업데이트하려면 아래를 참조하십시오)
...
**CFW v4.0 업데이트:** 최신 CFW 3.9를 설치하고 업데이트를 다운로드해야합니다 [(다운로드)](https://www.dropbox.com/s/97c5b0060x1kvnw/Bittboy_CFW4.0_Update_Only.zip?dl=0). 내용을 'main' 드라이브에 추출하고 묻는다면 바꿉니다.
